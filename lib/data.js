...
export const personalInfo = {
  ...
  bio: 'Backend developer con conocimientos de frontend, egresado con pensum cerrado de Ingeniería en Sistemas (Universidad Rafael Landívar). Aprendo mejor construyendo proyectos reales, me adapto rápido a equipos de trabajo y disfruto resolver problemas de arquitectura y datos.',
...
export const skills = {
  backend: ['Node.js', 'Express', 'MySQL', 'MariaDB', 'Python', 'JWT', 'bcryptjs'],
  frontend: ['Vue 3', 'Vite', 'Consumo de APIs REST'],
  tools: ['GitHub', 'Docker'],
};
...
export const projects = [
  {
    ...
    stack: [
      'Node.js', 'Express', 'MySQL', 'JWT', 'bcryptjs', 'Helmet',
      'Vue 3', 'Vite', 'Pinia', 'Tailwind CSS', 'Vercel',
    ],
    moduleCount: 18,
    year: '2025',
  },
